...
router.put(
  "/update-etat-personnel/:id",
  etatPersonnelController.updateEtatPersonnelById
);
// router.get('/getNote/:id', noteController.getNoteById);
router.get(
  "/get-all-etat-personnel",
  etatPersonnelController.getAllEtatPersonnel
);
router.delete(
  "/delete-etat-personnel/:id",
  etatPersonnelController.deleteEtatPersonnelById
);
// router.post('/getNotesByIdCompany',noteController.getNotesByIdCompany)
router.post("/get-etat-by-value", etatPersonnelController.getEtatByValue);
