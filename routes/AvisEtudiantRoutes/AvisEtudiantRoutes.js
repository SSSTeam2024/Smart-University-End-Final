...
router.get(
  "/get-all-avis-etudiants",
  avisEtudiantController.getAllAvisEtudiants
);
...
router.delete(
  "/delete-avis-etudiant",
  avisEtudiantController.deleteAvisEtudiant
);

// Delete many Avis Etudiant
router.delete("/delete-many", avisEtudiantController.deleteManyAvisEtudiant);
