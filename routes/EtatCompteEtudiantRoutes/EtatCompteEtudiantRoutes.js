...
router.put(
  "/update-etat-etudiant/:id",
  etatEudiantController.updateEtatEtudianttById
);
...
router.delete(
  "/delete-etat-etudiant/:id",
  etatEudiantController.deleteEtatEtudianttById
);
// router.post('/getNotesByIdCompany',noteController.getNotesByIdCompany)
router.post("/get-etat-by-value", etatEudiantController.getEtatByValue);
