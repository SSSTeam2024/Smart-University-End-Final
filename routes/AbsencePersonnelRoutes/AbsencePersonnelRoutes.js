...
router.post('/add-absence-personnel', absencePersonnelController.addAbsencePersonnel);
router.get('/get-all-absence-personnel', absencePersonnelController.getAllAbsencesPersonnels);
router.post('/get-absence-personnel', absencePersonnelController.getAbsencePersonnelById);
