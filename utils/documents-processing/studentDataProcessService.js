...
async function processFrenshStudentData(demandId) {

    const demandData = await demandStudentDao.getDemandeEtudiantById(demandId)
...
async function processArabicStudentData(demandId) {
