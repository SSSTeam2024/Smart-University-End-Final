...
async function processFrenshTeacherData(demandId) {

    const demandData = await demandTeacherDao.getDemandeEnseignantById(demandId)
...
async function processArabicTeacherData(demandId) {
