...
const updateStagePfe = async (req, res) => {
  try {
    ...
    if (
      file_rapport_base64 &&
      file_rapport_base64.trim() !== "" &&
      file_rapport_extension &&
      file_rapport_extension.trim() !== ""
    ) {
    ...
    if (
      file_affectation_etudiant_base64 &&
      file_affectation_etudiant_base64.trim() !== "" &&
      file_affectation_etudiant_extension &&
      file_affectation_etudiant_extension.trim() !== ""
    ) {
      const file = globalFunctions.generateUniqueFilename(
        file_affectation_etudiant_extension,
        "AffectationEtudiant"
    ...
    if (
      file_affectation_binome_base64 &&
      file_affectation_binome_base64.trim() !== "" &&
      file_affectation_binome_extension &&
      file_affectation_binome_extension.trim() !== ""
    ) {
      const file = globalFunctions.generateUniqueFilename(
        file_affectation_binome_extension,
        "AffectationBinome"
    ...
    if (
      file_proposition_base64 &&
      file_proposition_base64.trim() !== "" &&
      file_proposition_extension &&
      file_proposition_extension.trim() !== ""
    ) {
      const file = globalFunctions.generateUniqueFilename(
        file_proposition_extension,
        "Proposition"
    ...
    if (
      file_proposition_signe_base64 &&
      file_proposition_signe_base64.trim() !== "" &&
      file_proposition_signe_extension &&
      file_proposition_signe_extension.trim() !== ""
    ) {
      const file = globalFunctions.generateUniqueFilename(
        file_proposition_signe_extension,
        "PropositionSigne"
    ...
    if (
      file_attestation_base64 &&
      file_attestation_base64.trim() !== "" &&
      file_attestation_extension &&
      file_attestation_extension.trim() !== ""
    ) {
      const file = globalFunctions.generateUniqueFilename(
        file_attestation_extension,
        "Attestation"
    ...
    console.error("Error while updating stage pfe in controller:", error);
    res.status(500).send(error.message);
  }
};
