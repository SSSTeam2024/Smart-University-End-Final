...
const getAvisPersonnelById = async (req, res) => {
  try {
    const avisPersonnel = await avisPersonnelService.getAvisPersonnelById(
      req.body._id,
      useNewDb(req)
    );
    if (!avisPersonnel) {
...
const updateAvisPersonnel = async (req, res) => {
  try {
    ...
    const updatedAvisPersonnel = await avisPersonnelService.updateAvisPersonnel(
      _id,
      {
        title,
        description,
...
const deleteAvisPersonnel = async (req, res) => {
  try {
    const deletedAvisPersonnel = await avisPersonnelService.deleteAvisPersonnel(
      req.body._id,
      useNewDb(req)
    );
...
const deleteManyAvisPersonnel = async (req, res) => {
  try {
    ...
    const deleteAvisResult = await avisPersonnelService.deleteManyAvisPersonnel(
      useNewDb(req),
      avisIds
    );
